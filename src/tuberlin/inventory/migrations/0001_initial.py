# Generated by Django 3.0.7 on 2021-11-25 06:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(default='', help_text='Kategorie', max_length=200)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approximate', models.BooleanField(default=False, verbose_name='Messung ist ungefähr')),
                ...
                ('count', models.FloatField(blank=True, default=0.0, null=True, verbose_name='Stückanzahl')),
                ...
                ('material', models.ManyToManyField(to='inventory.MaterialCategory', verbose_name='Materialkategorien')),
